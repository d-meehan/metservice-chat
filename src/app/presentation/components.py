...
def chart_options() -> dict:
    """
    NiceGUI requires chart options to be generated to ensure each client gets its on copy rather than sharing. These are the options to load an initial shell chart.
    """
    return {
        'time': {'useUTC': False},
